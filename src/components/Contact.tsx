  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-8">
      ...
      <div className="relative w-full max-w-6xl">
        {/* Main content area */}
        <div className="flex items-center justify-center min-h-[600px] z-10">
          ...
          <motion.div
            ...
            variants={fadeUp}
          >
            <ApostropheSVG className="h-55 w-auto opacity-90 mb-20" />
            <div className="absolute top-0 left-25 flex flex-col items-start">
              <span className="text-xs font-bold leading-none">SPECIAL</span>
              <span className="text-xs font-bold leading-none">EDITION</span>
            </div>
          </motion.div>
          ...
          >
            <div className="mb-2">
              <span className="text-sm">Get in touch with</span>
            </div>
          ...
          <motion.div
            ...
            variants={fadeUp}
          >
            <ApostropheSVG className="h-55 w-auto opacity-90 mt-45 rotate-180" />
            <div className="absolute bottom-0 right-25 flex flex-col items-end">
              <span className="text-xs font-bold leading-none">I'M</span>
              <span className="text-xs font-bold leading-none">KAVEEN</span>
            </div>
          </motion.div>
        </div>
      </div>
